...
#include <fstream> // Pozwala nam uzywac systemu plikow naszego komputera
...
int main() {
    ...
    ofstream userLog("latest.txt", ios::app); // Tworzymy nowy plik o nazwie "latest.txt"
    ...
    userLog.close(); // Zamykamy nasz plik
